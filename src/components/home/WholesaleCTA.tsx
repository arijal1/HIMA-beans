...
function SocialProofBadge({ text }: SocialProofBadgeProps) {
  return (
    <div
      ...
      style={{ background: 'rgba(212,165,90,0.15)', border: '1px solid rgba(212,165,90,0.35)' }}
    >
      <span
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col lg:flex-row pointer-events-none" aria-hidden="true">
        ...
        <div className="h-1/2 lg:h-auto lg:flex-1" style={{ background: '#1F4D4F' }} />
        <div className="h-1/2 lg:h-auto lg:flex-1" style={{ background: '#D4A55A' }} />
      </div>
      ...
      <div
        ...
        aria-hidden="true"
        style={{
          background: 'linear-gradient(to bottom right, #1F4D4F 50%, #D4A55A 50%)',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-24 items-center">
          ...
          >
            ...
            >
              Partner
              <br />
              <em className="not-italic" style={{ color: '#D9DFDC' }}>
                with Us.
              </em>
            </motion.h2>
          ...
          >
            <div
              ...
              style={{
                background: 'rgba(217,223,220,0.08)',
                border: '1px solid rgba(217,223,220,0.15)',
            ...
            >
              ...
              <span
                ...
                style={{ background: '#F6F1E9', opacity: 0.5 }}
                aria-hidden="true"
              />
              <span
