...
export default function HomeStory() {
  return (
    <section style={{ backgroundColor: '#1a0f09' }} className="section-gap">
      <div className="site-container">
        ...
        <motion.p
          ...
          className="text-[#B08D57] text-[10px] tracking-[0.4em] uppercase text-center mb-8"
        ...
        >
          <p
            className="text-[#F5EFE6] italic leading-[1.4]"
            style={{
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true, margin: '-60px' }}
          style={{ width: '40px', height: '1px', backgroundColor: '#B08D57', margin: '2.5rem auto' }}
        />
        ...
        >
          {STATS.map((s) => (
            <div key={s.value} className="text-center">
              ...
              <p
                className="text-[#8C8477] text-[11px] tracking-[0.2em] uppercase mt-2"
                style={{ fontFamily: 'var(--font-inter, Inter, sans-serif)' }}
              >
                {s.label}
              </p>
        ...
        >
          <Link
            href="/about"
            className="inline-flex items-center gap-3 text-[#F5EFE6] text-[11px] tracking-[0.25em] uppercase hover:text-[#B08D57] transition-colors duration-300 group"
            style={{ fontFamily: 'var(--font-inter, Inter, sans-serif)' }}
          >
            Our Story
