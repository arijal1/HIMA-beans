...
const PILLARS: Pillar[] = [
    ...
    icon: (
      <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-9 h-9">
        <path
          ...
          stroke="#D4A55A" strokeWidth="1.5" strokeLinejoin="round"
        />
        <path d="M14 18l4 4 8-8" stroke="#D4A55A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
    ...
    icon: (
      <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-9 h-9">
        <path
          ...
          stroke="#D4A55A" strokeWidth="1.5" strokeLinejoin="round"
        />
        <path d="M20 35V22" stroke="#D4A55A" strokeWidth="1.5" strokeLinecap="round" />
        <path d="M14 27l6-5 6 5" stroke="#D4A55A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
    title: 'Shade Grown',
    description:
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-9 h-9">
        <circle cx="10" cy="20" r="3" stroke="#D4A55A" strokeWidth="1.5" />
        <circle cx="30" cy="20" r="3" stroke="#D4A55A" strokeWidth="1.5" />
        <circle cx="20" cy="10" r="3" stroke="#D4A55A" strokeWidth="1.5" />
        <circle cx="20" cy="30" r="3" stroke="#D4A55A" strokeWidth="1.5" />
        <path d="M13 20h14M20 13v14" stroke="#D4A55A" strokeWidth="1.5" strokeLinecap="round" />
        <path d="M12.5 12.5l15 15M27.5 12.5l-15 15" stroke="#D4A55A" strokeWidth="1.5" strokeLinecap="round" strokeOpacity="0.4" />
      </svg>
    ),
    ...
    icon: (
      <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-9 h-9">
        <path
          ...
          stroke="#D4A55A" strokeWidth="1.5" strokeLinejoin="round"
        />
        <path d="M20 22V10M16 14l4-4 4 4" stroke="#D4A55A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
    ...
    <div ref={ref} className="mb-5 sm:mb-6">
      <div className="flex items-baseline gap-0.5">
        ...
        <span
          ...
          style={{ color: '#D4A55A', fontFamily: '"Playfair Display", Georgia, serif' }}
        >
          {suffix}
        </span>
      </div>
      <p className="text-xs tracking-[0.2em] uppercase mt-1" style={{ color: '#6B7F7E' }}>
        {label}
      </p>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{ background: 'rgba(212,165,90,0.05)' }}
      />
      ...
      <h3
        ...
        style={{ color: '#F6F1E9', fontFamily: '"Playfair Display", Georgia, serif' }}
      >
        {pillar.title}
      </h3>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: 'linear-gradient(90deg, transparent, #D4A55A 30%, #D4A55A 70%, transparent)' }}
        aria-hidden="true"
      />
      ...
      >
        ...
        <div className="mb-10 sm:mb-14 lg:mb-20 max-w-2xl">
          ...
          >
            Earth First,
            <br />
            <em className="not-italic" style={{ color: '#D4A55A' }}>Cup Second.</em>
          </motion.h2>
        ...
        >
          <Link
            ...
            style={{ color: '#D4A55A' }}
          >
            <span className="h-px w-8 transition-all duration-300 group-hover:w-14" style={{ background: '#D4A55A' }} />
