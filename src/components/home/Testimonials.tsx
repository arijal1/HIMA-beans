...
function Avatar({ initials }: { initials: string }) {
  return (
    <div
      ...
      style={{ background: '#182118', color: '#7B5920' }}
      aria-hidden="true"
    >
      {initials}
    </div>
    ...
    >
      ...
      <div className="flex items-center gap-3 min-w-0">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="text-xs leading-snug truncate" style={{ color: '#6E675F' }}>
            {testimonial.role}
        ...
        >
          ...
          <div className="flex items-baseline gap-2">
            ...
            <div>
              ...
              <p className="text-xs mt-0.5" style={{ color: '#6E675F' }}>
                Average rating
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-xs" style={{ color: '#6E675F' }}>
