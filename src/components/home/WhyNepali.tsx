...
function MountainIcon() {
  return (
    ...
    >
      ...
      />
      {/* Altitude marker */}
      <line x1="18" y1="14" x2="18" y2="9" stroke="#7B5920" strokeWidth="1.4" strokeLinecap="round" />
      <line x1="14.5" y1="9" x2="21.5" y2="9" stroke="#7B5920" strokeWidth="1.4" strokeLinecap="round" />
    </svg>
  );
}
...
function HandIcon() {
  return (
    ...
    >
      ...
      />
      {/* Cherry on palm */}
      <circle cx="18.5" cy="26" r="2" fill="#7B5920" opacity="0.45" />
    </svg>
  );
}
...
function BeanIcon() {
  return (
    ...
    >
      ...
      />
      {/* Origin dots */}
      <circle cx="29" cy="14" r="2" fill="#7B5920" opacity="0.5" />
      <circle cx="33" cy="20" r="1.5" fill="#7B5920" opacity="0.3" />
      <circle cx="31" cy="27" r="1" fill="#7B5920" opacity="0.25" />
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-2 sm:gap-3">
        ...
        <p className="text-sm leading-[1.8] font-light" style={{ color: '#6E675F' }}>
          {feature.description}
        </p>
      </div>
      ...
      >
        ...
        >
          ...
          >
            Why Nepali
            <br />
            <em style={{ fontStyle: 'italic', color: '#7B5920' }}>Coffee?</em>
          </motion.h2>
        ...
        >
          {[
            ...
            >
              ...
              <span className="text-[10px] tracking-[0.3em] uppercase" style={{ color: '#6E675F' }}>
                {label}
              </span>
            </motion.div>
          ))}
