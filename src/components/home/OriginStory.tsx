...
const PHOTO_FRAMES = [
  {
    ...
    gradient: 'linear-gradient(145deg, #1F4D4F 0%, #1E4042 55%, #355E3B 100%)',
    rotation: -2.5,
    offsetY: 0,
    accentColor: '#D4A55A',
  },
  {
    ...
    gradient: 'linear-gradient(155deg, #2B4A4C 0%, #1F4D4F 50%, #1E4042 100%)',
    rotation: 1.8,
    offsetY: -20,
    accentColor: '#C4A97A',
  },
  {
    ...
    gradient: 'linear-gradient(130deg, #1E4042 0%, #2B4A4C 45%, #1F4D4F 100%)',
    rotation: -1.2,
    offsetY: -8,
    accentColor: '#8C6A3F',
  },
    ...
    <div className="overflow-hidden rounded-sm">
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 80% 50% at 50% 20%, rgba(217,223,220,0.07) 0%, transparent 70%)',
          }}
          aria-hidden="true"
        />
...
export default function OriginStory() {
  ...
  return (
    <section
      ref={sectionRef}
      style={{ backgroundColor: '#1F4D4F', position: 'relative', overflow: 'hidden' }}
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(to right, transparent, #D4A55A 30%, #D4A55A 70%, transparent)',
        }}
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-10 py-12 md:py-20 lg:py-36">
        ...
        >
          ...
          >
            Born in the Clouds,
            <br />
            <em style={{ fontStyle: 'italic', color: '#D4A55A' }}>Grown by Hand</em>
          </motion.h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 xl:gap-24 items-start mb-12 md:mb-20 lg:mb-32">
          ...
          >
            ...
            <motion.div variants={childUp} className="flex flex-col gap-5">
              <p
                ...
                style={{ color: 'rgba(217,223,220,0.72)' }}
              >
              ...
              >
                ...
                <span style={{ color: '#D4A55A', fontWeight: 500 }}>Gulmi</span> and{' '}
                <span style={{ color: '#D4A55A', fontWeight: 500 }}>Palpa</span>. Today the
                growing regions of{' '}
                <span style={{ color: '#D4A55A', fontWeight: 500 }}>Syangja</span>,{' '}
                <span style={{ color: '#D4A55A', fontWeight: 500 }}>Kavre</span>, and beyond
            ...
            <motion.div variants={childUp} className="flex flex-wrap gap-2.5 pt-1">
              {['Gulmi', 'Palpa', 'Syangja', 'Kavre', 'Nuwakot'].map((region) => (
                <span
                  ...
                  style={{
                    backgroundColor: 'rgba(212,165,90,0.1)',
                    color: '#D4A55A',
          ...
          <div className="relative flex flex-col gap-5 pt-4 lg:pt-6 overflow-hidden">
            ...
            <div
              ...
              style={{
                backgroundImage:
                  'radial-gradient(circle, rgba(212,165,90,0.22) 1px, transparent 1px)',
            ...
            <div
              ...
              style={{
                backgroundImage:
                  'radial-gradient(circle, rgba(212,165,90,0.16) 1px, transparent 1px)',
        ...
        <div>
          ...
          <div
            ...
            style={{ border: '1px solid rgba(212,165,90,0.14)' }}
          >
            {REGIONS.map((region, i) => (
              <motion.div
                ...
                style={{
                  backgroundColor: 'rgba(217,223,220,0.025)',
                  borderRight:
                    i % 3 !== 2 ? '1px solid rgba(212,165,90,0.12)' : 'none',
                  borderBottom:
                    i < 3 ? '1px solid rgba(212,165,90,0.12)' : 'none',
                }}
              >
                ...
                <p className="text-sm leading-relaxed" style={{ color: 'rgba(217,223,220,0.6)' }}>
                  {region.trait}
                </p>
