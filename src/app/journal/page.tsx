...
function CategoryPill({
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.97 }}
      className="relative px-5 py-2 text-xs tracking-[0.25em] uppercase transition-colors duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7C5535]"
      style={{
        background: active ? '#1E1008' : 'transparent',
        color: active ? '#F2E8D8' : '#87705A',
        border: `1px solid ${active ? '#1E1008' : '#EDE0CC'}`,
      }}
      aria-pressed={active}
    >
      {label}
    ...
    >
      ...
      <div className="relative overflow-hidden" style={{ height: '220px' }}>
        <motion.div
          ...
          style={{
            background: `linear-gradient(135deg, ${accentColor}22 0%, #EDE0CC 50%, ${accentColor}15 100%)`,
          }}
      ...
      <div className="flex flex-col flex-1 p-7">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-[11px] tracking-wider" style={{ color: '#87705A' }}>
        ...
        >
          <span className="text-[11px] tracking-wide" style={{ color: '#87705A' }}>
            {article.date}
          </span>
          <motion.span
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(circle at 20% 80%, #7C5535 2px, transparent 2px), radial-gradient(circle at 80% 20%, #F2E8D8 1px, transparent 1px)',
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-0">
        ...
        <div
          ...
          style={{ minHeight: '360px', background: 'linear-gradient(135deg, #2D1B12 0%, #4a3728 60%, #1E1008 100%)' }}
        >
          <motion.div
            className="absolute inset-0"
            ...
            style={{
              background:
                'linear-gradient(135deg, #2D1B12 0%, #4a3728 50%, #7C553520 100%)',
            }}
          />
          ...
          <div className="absolute top-8 left-8">
            <span
              ...
              style={{ background: '#7C5535', color: '#F2E8D8' }}
            >
              Featured
            </span>
          </div>
        ...
        <div className="flex flex-col justify-center px-10 py-14 lg:px-16">
          ...
          <div className="flex items-center justify-between">
            <span className="text-xs tracking-wide" style={{ color: '#87705A' }}>
              May 24, 2025
            </span>
            <motion.button
              whileHover={{ x: 6 }}
              transition={{ type: 'spring', stiffness: 300, damping: 20 }}
              className="flex items-center gap-3 text-sm tracking-[0.15em] uppercase font-medium transition-colors duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7C5535] rounded"
              style={{ color: '#7C5535' }}
            >
              Read the Story
...
export default function JournalPage() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#F2E8D8' }}>
      {/* ── Page Header ── */}
      <header
      ...
      >
        ...
        <div className="site-container relative z-10">
          ...
          <motion.div
            ...
            style={{ background: 'linear-gradient(to right, #7C5535, transparent)' }}
      ...
      <main className="site-container py-16">
        ...
        {filtered.length === 0 && (
          ...
          >
            <p className="text-lg" style={{ color: '#87705A' }}>
